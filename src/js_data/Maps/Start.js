...
BBAdata.MAPS.Start = {
    Place:[
        ...
        {CircleOf:{X:0, Y:-2500, Radius: 300, Angle: 160, AnglePlus: -7}, What:{Star:23},objData:{explodePreset:'ExplosionSize1'}},
        {CircleOf:{X:0, Y:-2500, Radius: 300, Angle: 200, AnglePlus: 7}, What:{Star:23},objData:{explodePreset:'ExplosionSize1'}},
