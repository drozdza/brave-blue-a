...
BBAdata.MAPS.Backgrounds = {
    ...
    Place:[
        ...
        //
        // {CircleOf:{X: 0, Y:0, Radius: 1000, Angle: 0, AnglePlus: 4}, What:{Mine:90},objData:{explodePreset:'NailedMine'}},
        ...
        {CircleOf:{X:0, Y:0, Radius: 400, Angle: 0, AnglePlus: 15},  Background:1, What:{RoundField:24},  objData:{radius:30, simpleFilling:'rgba(255,255,0,0.7)'}},
        {LineOf:{X:300, Y:0, Angle: 270, Distance: 100},                Background:1, What:{RoundField:7},   objData:{radius:30, simpleFilling:'rgba(255,255,0,0.7)'}},
        {LineOf:{X:0, Y:300, Angle: 0, Distance: 100},                  Background:1, What:{RoundField:7},   objData:{radius:30, simpleFilling:'rgba(255,255,0,0.7)'}},
        ...
        {CircleOf:{X:0, Y:0, Radius: 350, Angle: 0, AnglePlus: 15},  Background:2, What:{RoundField:24},  objData:{radius:20, simpleFilling:'rgba(0,0,120,0.7)'}},
        ...
        {CircleOf:{X:0, Y:0, Radius: 300, Angle: 0, AnglePlus: 15},  Background:3, What:{RoundField:24},  objData:{radius:10, simpleFilling:'rgba(0,120,0,1)'}},
