BBAdata['MAPS']['Secure'] = {
    ...
    WinningConds:[
        {T:'Main',C:{'E:enemies':{max:0,D:'killLeft'}}, Reward:{Gold:150,Conquer:1}, EndPortal:{X:200,Y:0}},
        {T:'Main',C:{'D:orhenes':{min:6,D:'killMin'},'D:koriaz':{max:0,D:'DsaveMax'}}, Reward:{Gold:100}},
        {T:'Main',C:{'D:carras':{min:100,D:'killMin'}}, Reward:{Gold:100,Conquer:1}},
        ...
        {T:'Add',C:{S_lifeHealed:{max:0},gameEnded:{min:1,D:'hidden'}}, Reward:{Gold:100}},
        {T:'Add',C:{'D:carras':{max:0}}, Reward:{Gold:100}},
        {T:'Add',C:{'D:carras':{min:20}}, hideOnPending: true},
        {T:'Add',C:{'D:carras':{min:100,D:'killMin'},S_lifeLost:{max:0},S_shieldLost:{max:0}}, Reward:{Gold:100}},
    ],
