...
BBAdata.SHIPelements['exploShield'] = {             Weight: 5, Price: 2000,
    ...
    EnergyM: -3,
    ShieldStorage:{'explosion':{R:0,M:1}},
    upgrades: {
        'up1':{ShieldStorage:{'explosion':{M:1}},EnergyM:-4},
        'up2':{ShieldStorage:{'explosion':{M:1}},EnergyM:-5},
        'up3':{ShieldStorage:{'explosion':{M:1}},EnergyM:-6},
    },
};
...
BBAdata.SHIPelements['absShield'] = {               Weight: 5, Price: 2000,
    ...
    EnergyM: -1,
    ShieldStorage:{'absorbtion':{R:0,M:1}},
    upgrades: {
        'up1':{ShieldStorage:{'absorbtion':{M:1}},EnergyM:-1},
        'up2':{ShieldStorage:{'absorbtion':{M:2}},EnergyM:-2},
        'up3':{ShieldStorage:{'absorbtion':{M:2}},EnergyM:-2},
        'up4':{ShieldStorage:{'absorbtion':{M:3}},EnergyM:-3},
        'up5':{ShieldStorage:{'absorbtion':{M:3}},EnergyM:-3},
        'up6':{ShieldStorage:{'absorbtion':{M:4}},EnergyM:-4},
        'up7':{ShieldStorage:{'absorbtion':{M:5}},EnergyM:-5},
        'up8':{ShieldStorage:{'absorbtion':{M:6}},EnergyM:-6},
        'up9':{ShieldStorage:{'absorbtion':{M:6}},EnergyM:-6},
    },
};
...
BBAdata.SHIPelements['roseGun'] = {                 Weight: 12, Price: 1500,  where:'weapons',
    ...
    upgrades: {
        ...
        'up14': {                                   Price: 2500,
            ...
            Storage:{Ammo:{M:16,Hidden:16}},
        },
        'up15': {                                   Price: 3100,
            WeaponData:{Use:{Ammo:-12}},
            Storage:{Ammo:{M:-12,Hidden:-12}},
        },
        'up16': {                                   Price: 4100,
...
BBAdata.SHIPelements['laserProd'] = {               Weight: 5, Price: 100, where:'modules',
    ...
    ModStorage:{Laser:{R:0,M:1}},
    upgrades: {
        'up1':{ModStorage:{Laser:{M:1}}},
        'up2':{ModStorage:{Laser:{M:2}}},
