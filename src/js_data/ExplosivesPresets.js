BBAdata.ExplosivesPresets={
    ...
    DestructionFieldGiant:{
        onHitDieExpire: {Do:'explode',explodeType: 'RoundField', radius:200, fieldAnim: 'DestructionField', PeriodDMG:{Dmg:1,T:'normal'}, PeriodTime: 40, PeriodOffset: 50, ExpireTime: 300, mapType:'F'},
    },

    DestructionFieldMedium:{
        onHitDieExpire: {Do:'explode',explodeType: 'RoundField', radius:160, fieldAnim: 'DestructionField', PeriodDMG:{Dmg:1,T:'normal'}, PeriodTime: 10, PeriodOffset: 10, ExpireTime: 300, mapType:'F'},
    },

    DestructionFieldSmall:{
        onHitDieExpire: {Do:'explode',explodeType: 'RoundField', radius:35, fieldAnim: 'DestructionField', PeriodDMG:{Dmg:1,T:'normal'}, PeriodTime: 10, PeriodOffset: 10, ExpireTime: 300, mapType:'F'},
    },

    MissileDestructionFieldSmall:{
        onHit:    {Do:'explode',explodeType: 'RoundField', radius:50, fieldAnim: 'DestructionField', PeriodDMG:{Dmg:1,T:'normal'}, PeriodTime: 10, PeriodOffset: 10, ExpireTime: 300, mapType:'F'},
        onExpire: {Do:'explode',explodeType: 'RoundField', radius:50, fieldAnim: 'DestructionField', PeriodDMG:{Dmg:1,T:'normal'}, PeriodTime: 10, PeriodOffset: 10, ExpireTime: 300, mapType:'F'},
    },
    MissileDestructionFieldGiant:{
        onHit:    {Do:'explode',explodeType: 'RoundField', radius:230, fieldAnim: 'DestructionField', PeriodDMG:{Dmg:1,T:'normal'}, PeriodTime: 10, PeriodOffset: 10, ExpireTime: 300, mapType:'F'},
        onExpire: {Do:'explode',explodeType: 'RoundField', radius:230, fieldAnim: 'DestructionField', PeriodDMG:{Dmg:1,T:'normal'}, PeriodTime: 10, PeriodOffset: 10, ExpireTime: 300, mapType:'F'},
    },

    BubbleMissile:{
        onHitDieExpire: {Do:'explode',explodeType:'RoundField', fieldAnim: 'ElectricityField', OneTimeEffect: 1, OneTimeOffset: 0, OneTimeDMG:{Dmg:3,T:'energy'}, OnDamageExpire:1, ExpireTime:60, moveAlong: 5, mapType:'PF'},
    },
    BubbleStorm:{
        Dec: 30,
        Speed: 8,
    ...
    ElectroBubble:{
        onHitDieExpire: {Do:'explode', explodeType:'RoundField', fieldAnim: 'ElectricityField', OneTimeEffect: 1, OneTimeOffset: 0, OneTimeDMG:{Dmg:3,T:'energy'}, OnDamageExpire:1, ExpireTime:240, angle: 0, mapType:'PF', radius: 30, radiusPlus: 30},
    },
    ElectroBubbleShield:{
        Dec: 30,
        Speed: 8,
    ...
    TeleField:{
        onHitDieExpire: {Do:'explode', explodeType:'RoundField', simpleFilling: 'rgba(0,0,255,0.2)', teleportOnHit: 'withAngle', teleportOnHitDist: 520, teleportOnHitDistPlus: 200, ExpireTime:90, moveAlong:6, mapType:'PF', radius: 30},
    },
    TeleFastField:{
        onHitDieExpire: {Do:'explode', explodeType:'RoundField', simpleFilling: 'rgba(0,0,255,0.2)', teleportOnHit: 'withAngle', teleportOnHitDist: 520, teleportOnHitDistPlus: 200, ExpireTime:60, moveAlong:12, mapType:'F', dontHit:['E','EB','EM'], radius: 45},
    },
    ...
    WindBall:{
        onHitDieExpire: {Do:'explode', explodeType:'RoundField', fieldAnim:'WindField', ExpireTime:90, mapType:'F', dontHit:['E','EM','EB'], radius: 55, vectorType:'wind', vectorForce:5}},
    WindBalls:{
        onExpire: {
            Do:'explode',
            explodeType: 'none',
    ...
    SlowDownConeFields:{
        onHitDieExpire:{ Do:'explode', explodeType:'ConeField', fieldAnim: 'ShellField', SlowDownTo: 2.5, SlowDownBy: 11, mapType:'F', dontHit:['E','EM','EB'], ExpireTime: 240, radius: 160, coneAngle: 80, coneRad2: 110}
    },

    TeleportConeField:{
        onHitDieExpire:{ Do:'explode', explodeType:'ConeField', simpleFilling: 'rgba(0,0,255,0.2)', ExpireTime:240, mapType:'F', dontHit:['E','EM','EB'], teleportOnHit: 'withAngle', teleportOnHitDist: 520, teleportOnHitDistPlus: 200, radius: 160, coneAngle: 80, coneRad2: 110}
    },
    ...
    HealingField:{
        onHitDieExpire: {Do:'explode', explodeType:'RoundField', fieldAnim: 'HealingField', ExpireTime: 360, PeriodTime: 30, PeriodOffset: 5, PeriodHeal: 1, mapType:'EF', radius: 160},
    },
    ...
    GraviBall:{
        onHitDieExpire: {Do:'explode', explodeType:'RoundField', fieldAnim: 'GravityField', vectorType:'gravity',vectorForce:9, ExpireTime:170, moveAlong:6, mapType:'F', dontHit:['E','EM','EB'], radius: 120},
    },
