BOARDS={
    ...
    'H':{
        BoardMods:['sitOnMap'],
        Place:[{Random:{X: 400, Y: 0, Radius: 200}, What:{Star: 20, H: 10}}],
    },
    'HardCore':{
        BoardMods:['sitOnMap','allAvoid'],
        Place:[{Random:{X: 0, Y: 0, Radius: 2200}, What:{Star:120, A:15, U:10, S:10, I:10, D:10, M:10, N:10, J:10, W:5, T:10, E:10, C:10, G:10, R:10, H:10}}],
    },
