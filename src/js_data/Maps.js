BBAdata['MAPS']={
    ...
    'u2':{
        ...
        Place:[
            ...
            {What:{ConeField:1},objData:{x:0,y:0, radius: 600, angle: 90, coneAngle: 178, coneRad2: 580, simpleFilling: 'rgba(0,180,0,0.6)', bounceType:'diagonal',bounceTeleport:true}},
        ],
    },
    'u3':{
        BoardMods:['sitOnMap','allAvoid'],
        Place:[
            ...
            {What:{ConeField:1},objData:{x:0,y:0, radius: 1600, angle: 90, coneAngle: 179, coneRad2: 1300, simpleFilling: 'rgba(255,255,0,0.6)', bounceType:'diagonal',bounceTeleport:true}},
        ],
    },
    '1':{
        BoardMods:['sitOnMap','allAvoid'],
    ...
    'Lx992':{
        ...
        Place:[
            {RingOf:{X: 0, Y: 0, Radius: 800, RadiusPlus:200}, What:{StarX: 60}},
            {Random:{X: 0, Y: 0, Radius: 800}, What:{CD:6}}
        ],
    },
    'HealthSplit':{
    ...
    'HardCore':{
        BoardMods:['sitOnMap','allAvoid'],
        Place:[
            {Random:{X: 0, Y: 0, Radius: 2200}, What:{A:15, U:10, S:10, I:10, D:10, M:10, N:10, J:10, W:5, T:10, E:10, C:10, G:10, R:10, H:10, B:10, V:10, K:10, F:10, Q:5, X:6, Z:5, PI:10, WP:5,Ni:10,SH:10,L:5,TT:10}},
