BBAdata['SHIPpresetsOld']={
    'start':{
        ...
        Modules:[
            {T:'Prod',subT:'Bullet',Storage:'Ammo',Disabled:0,Emin:2,Emax:4,E:0,Prod:0,ifProd:5 },
            {T:'Prod',subT:'Bullet',Storage:'Ammo',Disabled:0,Emin:2,Emax:4,E:0,Prod:0,ifProd:5 },
        ],
        SpecialMoves:{
    ...
    'destFields':{
        ...
        Modules:[
            ...
            {T:'spotRegion',Disabled:1,Emin:4,Emax:4,E:0,Prod:0,ifProd:1 },
            {T:'moduleProd',Disabled:0,Emin:2,Emax:4,E:0,Prod:0,ifProd:15, subT:'TeleJump',ModStorage:'TeleJump'},
            {T:'healerProd',Disabled:0,Emin:4,Emax:16,E:0,Prod:0,ifProd:90 },
            {T:'Prod',      subT:'Missile',Storage:'Missile',Disabled:0,Emin:1,Emax:6,E:0,Prod:0,ifProd:1 },
            {T:'radar',     Disabled:1,Emin:1,Emax:30,E:0,Prod:0,ifProd:18,Radius:2500},
        ],
    },
    'bombs1':{
        Weight: 25,
        ...
        Modules:[
            ...
            {T:'moduleProd',Disabled:0,Emin:2,Emax:4,E:0,Prod:0,ifProd:15, subT:'TeleJump',ModStorage:'TeleJump'},
            {T:'healerProd',Disabled:0,Emin:4,Emax:16,E:0,Prod:0,ifProd:90 },
            {T:'Prod',      subT:'Bomb',Storage:'Bomb',Disabled:0,Emin:1,Emax:6,E:0,Prod:0,ifProd:1 },
            {T:'radar',     Disabled:1,Emin:1,Emax:30,E:0,Prod:0,ifProd:18,Radius:2500},
        ],
    },
    'bombs2':{
    ...
    'moves1':{
        ...
        Modules:[
            {T:'Prod', subT:'Bullet',Storage:'Ammo', Disabled:0,Emin:2,Emax:4,E:0,Prod:0,ifProd:3 },
            {T:'Prod', subT:'Bomb',  Storage:'Bomb', Disabled:0,Emin:1,Emax:10,E:0,Prod:0,ifProd:10 },
            {T:'moduleProd',Disabled:0,Emin:2,Emax:4,E:0,Prod:0,ifProd:20, subT:'Moves', ModStorage:'Moves'},
            {T:'healerProd',Disabled:0,Emin:1,Emax:16,E:0,Prod:0,ifProd:9 },
        ],
        SpecialMoves:{
    ...
    'best':{
        ...
        Modules:[
            ...
            {T:'spotRegion',Disabled:1,Prod:0,E:0,Emin:4,Emax:4, ifProd:1 },
            {T:'moduleProd',Disabled:0,Prod:0,E:0,Emin:2,Emax:4, ifProd:15, subT:'TeleJump', ModStorage:'TeleJump'},
            ...
            {T:'healerProd',Disabled:0,Prod:0,E:0,Emin:4,Emax:16,ifProd:90 },
            {T:'Prod',      Disabled:0,Prod:0,E:0,Emin:1,Emax:10,ifProd:60,subT:'Bomb',Storage:'Bomb'},
            {T:'Prod',      Disabled:0,Prod:0,E:0,Emin:1,Emax:6, ifProd:1,subT:'Missile',Storage:'Missile'},
            {T:'moduleProd',Disabled:1,Prod:0,E:0,Emin:2,Emax:4, ifProd:40, subT:'Laser', ModStorage:'Laser'},
            {T:'Prod',      Disabled:0,Prod:0,E:0,Emin:2,Emax:4, ifProd:15,subT:'Bullet',Storage:'Ammo'},
            {T:'Prod',      Disabled:0,Prod:0,E:0,Emin:6,Emax:12,ifProd:1.25,subT:'Bullet',Storage:'Ammo'},
            {T:'radar',     Disabled:1,Prod:0,E:0,Emin:1,Emax:30,ifProd:180,Radius:2500},
        ],
        SpecialMoves:{
    ...
    'bombardier':{
        ...
        Modules:[
            ...
            {T:'moduleProd',Disabled:0,Emin:2,Emax:4,E:0,Prod:0,ifProd:15, subT:'TeleJump', ModStorage:'TeleJump'},
            {T:'healerProd',Disabled:0,Emin:4,Emax:16,E:0,Prod:0,ifProd:90 },
            {T:'Prod',      Disabled:0,subT:'Bomb',Storage:'Bomb',Emin:1,Emax:10,E:0,Prod:0,ifProd:20 },
            {T:'Prod',      Disabled:0,subT:'Bomb',Storage:'Bomb',Emin:1,Emax:10,E:0,Prod:0,ifProd:20 },
            {T:'Prod',      Disabled:0,subT:'Bomb',Storage:'Bomb',Emin:1,Emax:10,E:0,Prod:0,ifProd:20 },
            {T:'radar',     Disabled:1,Emin:1,Emax:30,E:0,Prod:0,ifProd:18,Radius:2500},
        ],
    ...
    'bombardier2':{
        ...
        Modules:[
            ...
            {T:'moduleProd',Disabled:0,Emin:2,Emax:4,E:0,Prod:0,ifProd:15, subT:'TeleJump', ModStorage:'TeleJump'},
            {T:'healerProd',Disabled:0,Emin:4,Emax:16,E:0,Prod:0,ifProd:90 },
            {T:'Prod',      Disabled:0,subT:'Bomb',Storage:'Bomb',Emin:1,Emax:10,E:0,Prod:0,ifProd:15 },
            {T:'Prod',      Disabled:0,subT:'Bomb',Storage:'Bomb',Emin:1,Emax:10,E:0,Prod:0,ifProd:15 },
            {T:'Prod',      Disabled:0,subT:'Bomb',Storage:'Bomb',Emin:1,Emax:10,E:0,Prod:0,ifProd:15 },
            {T:'radar',     Disabled:1,Emin:1,Emax:30,E:0,Prod:0,ifProd:18,Radius:2500},
        ],
